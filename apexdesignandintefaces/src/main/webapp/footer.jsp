<%-- 
    Document   : footer
    Created on : Mar 15, 2021, 10:33:05 AM
    Author     : Sebastian
--%>
<footer class="w3-container w3-padding-16 w3-theme-d3 w3-center">
    <div class="w3-row">
        ...
        <div class="w3-col w3-center s4">
            ...
            <a class="w3-button w3-large w3-theme-l1" target="_blank" href="https://www.instagram.com/accounts/login/" title="Instagram"><i class="fa fa-instagram"></i></a>
        ...
        <div class="w3-col w3-left-align s4">
            ...
            <div class="w3-text-theme-light">
                ...
                <a target="_blank" href="https://www.newegg.com/">Newegg</a><br>
                <a target="_blank" href="https://www.amazon.com/">Amazon</a><br>
                <a target="_blank" href="https://www.microcenter.com/">Microcenter</a>
            </div>
        </div>
