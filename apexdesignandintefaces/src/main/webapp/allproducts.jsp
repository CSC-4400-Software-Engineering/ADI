...
<html>
    ...
    <body>
        <%            
            ...
            String productsScript = dbConnect.productScript("SELECT brand, model, price, productID FROM product ORDER BY stock DESC");
            out.print("<script>" + productsScript + "</script>");
            
            /* Create the in-line prodyct CSS */
            
            String productStyle = dbConnect.productStyle("SELECT productID, brand, model, price, stock FROM product ORDER BY stock DESC");
