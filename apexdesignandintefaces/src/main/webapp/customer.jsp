        ...
        <div class="w3-row">
            ...
            <div class="w3-twothird w3-padding">
                <div class="w3-card-4">
                    ...
                    <form name="customerSignUpForm" action="customerSignUpAction.jsp" class="w3-container" method="get" onsubmit="return (customerSignUp() && validate())">
                        ...
                        <div class="w3-row-padding">
                            <p>
                                <input class="w3-input w3-round w3-light-grey" name="streetAddress" type="text" id="streetAddress" required>
